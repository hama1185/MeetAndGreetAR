...
namespace ImageTracking_ImageTarget
{
    public class ImageTracking : MonoBehaviour
    {
        ...
        private ImageTargetController controllerMeimei;
        ...
        private void Awake()
        {
            ...
            // targets from scene
            controllerMeimei = GameObject.Find("ImageTarget-meimei").GetComponent<ImageTargetController>();
            imageTargetControllers[controllerMeimei] = false;
            AddTargetControllerEvents(controllerMeimei);
        ...
        public void SwitchCenterMode()
        {
            while (true)
            {
                ...
                {
                    Session.CenterTarget = controllerMeimei;
                }
